		...
		messages: [
			{
				...
				or if the contents look like they were generated by some default template. 
				In this case, output an empty JSON.
				Otherwise, if the README outlines a valid project, you must output exactly 3 bullet points
				summarizing the project. Do not include common README sections like installation and usage.
