  ...
  return (
    <>
      <motion.div whileHover={{ scale: 1.05 }}>
        <Card
          className="cursor-pointer bg-opacity-10 bg-gradient-to-br from-zinc-950 to-zinc-900 bg-clip-padding"
          // this css is for the background gradient
          onClick={handleOpen}
        >
          <CardHeader className="m-5 flex">
          ...
          <CardContent className="flex flex-row justify-between ">
            <ul className="ml-2 flex-grow list-disc space-y-8 [&>li]:mt-2">
            ...
            <Image
              ...
              width={300}
              height={300}
              className="mn-[300px] md:[400px] lg:[500px] xl:[600px] 2xl:[700px] m-2 rounded-3xl"
            />
          </CardContent>
